...
//                 !customLoader && 'flex items-center justify-center h-full w-full',
//                 className,
//             )}
//         >
//             {customLoader ? (
...
const DefaultLoading = (props: BaseLoadingProps) => {
    ...
    return loading ? (
        <Component
            className={classNames(
                !customLoader && 'flex items-center justify-center min-h-screen w-full', // Full height and center
                className,
            )}
        >
            {customLoader ? (
...
const CoveredLoading = (props: BaseLoadingProps) => {
    ...
    return (
        <Component
            className={classNames(loading ? 'relative min-h-screen w-full' : '', className)} // Full height and relative positioning
        >
            {children}
            {loading && (
                <div className="w-full h-full bg-white dark:bg-gray-800 dark:bg-opacity-60 bg-opacity-50 absolute inset-0" />
