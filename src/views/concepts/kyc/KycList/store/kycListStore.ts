...
import type { Kyc, Filter } from '../types'
...
export type CustomersListState = {
    ...
    filterData: Filter
    selectedCustomer: Partial<Kyc>[]
}

type CustomersListAction = {
    setFilterData: (payload: Filter) => void
    setTableData: (payload: TableQueries) => void
    setSelectedCustomer: (checked: boolean, customer: Kyc) => void
    setSelectAllCustomer: (customer: Kyc[]) => void
}
...
export const useKycListStore = create<
