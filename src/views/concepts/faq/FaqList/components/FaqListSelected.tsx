...
//         const newCustomerList = faqList.filter((faq) => {
//             return !selectedCustomer.some(
//                 (selected) => selected.id === faq._id,
//             )
//         })
//         setSelectAllCustomer([])
//         mutate(
...
//                 total: faqListTotal - selectedCustomer.length,
//             },
//             false,
//         )
//         setDeleteConfirmationOpen(false)
...
//                         <Tooltip key={customer.id} title={customer.question}>
...
// export default FaqListSelected
