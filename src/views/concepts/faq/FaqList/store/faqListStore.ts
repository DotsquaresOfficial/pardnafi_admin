...
import type { Faq, Filter } from '../types'
...
export type CustomersListState = {
    ...
    filterData: Filter
    selectedCustomer: Partial<Faq>[]
}

type CustomersListAction = {
    setFilterData: (payload: Filter) => void
    setTableData: (payload: TableQueries) => void
    setSelectedCustomer: (checked: boolean, customer: Faq) => void
    setSelectAllCustomer: (customer: Faq[]) => void
}
...
export const useFaqListStore = create<
