...
const InquiryListSelected = () => {
    ...
    const handleConfirmDelete = () => {
        const newCustomerList = inquiryList.filter((customer) => {
        ...
        mutate(
            {
                ...
                total: inquiryListTotal - selectedCustomer.length,
            },
            false,
        )
        setDeleteConfirmationOpen(false)
            ...
            >
                ...
                >
                    {selectedCustomer.map((customer) => (
                        <Tooltip key={customer.id} title={customer.firstName}>
...
export default InquiryListSelected
