...
import type { Terms, Filter } from '../types'
...
export type CustomersListState = {
    ...
    filterData: Filter
    selectedCustomer: Partial<Terms>[]
}

type CustomersListAction = {
    setFilterData: (payload: Filter) => void
    setTableData: (payload: TableQueries) => void
    setSelectedCustomer: (checked: boolean, Terms: Terms) => void
    setSelectAllCustomer: (Terms: Terms[]) => void
}
...
export const useTermsListStore = create<
